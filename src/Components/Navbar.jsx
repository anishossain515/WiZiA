    ...
    >
      ...
      <NavbarContent justify="end">
        ...
        <NavbarItem className="md:flex hidden">
          <Button className="bg-Aqua text-dark_teal font-medium md:flex hidden rounded-[100px]  shadow-glow">
            Book a Demo
          </Button>
        </NavbarItem>
      ...
      <NavbarMenu className="bg-[#063740]">
        ...
        <NavbarMenuItem className="space-x-4 pt-2">
          ...
          <Button className="bg-Aqua text-dark_teal font-medium rounded-[100px]  shadow-glow">
            Book a Demo
          </Button>
        </NavbarMenuItem>
      </NavbarMenu>
